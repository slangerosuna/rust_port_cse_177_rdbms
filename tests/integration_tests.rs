...
mod tests {
    ...
    fn test_record_basic_operations() {
        ...
        assert!(record.get_column(0).is_none(), "get_column on empty record should return None");
        assert!(record.get_column(100).is_none(), "get_column with invalid index should return None");
    }
    ...
    fn test_record_extract_from_pipe_delimited() {
        ...
        let types = vec!["Integer".to_string(), "String".to_string(), "Float".to_string()];
    ...
    fn test_record_project() {
        ...
        let attributes = vec!["id".to_string(), "name".to_string(), "age".to_string(), "job".to_string()];
        let types = vec!["Integer".to_string(), "String".to_string(), "Integer".to_string(), "String".to_string()];
    ...
    fn test_record_merge() {
        ...
        let schema1 = Schema::new(&schema1_attrs, &schema1_types, &schema1_distincts, 0, "test1.tbl");
        ...
        let schema2 = Schema::new(&schema2_attrs, &schema2_types, &schema2_distincts, 0, "test2.tbl");
    ...
    fn test_schema_find_type() {
        ...
        let types = vec!["Integer".to_string(), "Float".to_string(), "String".to_string()];
        let distincts = vec![0, 0, 0];
    ...
    fn test_schema_project() {
        let attributes = vec!["a".to_string(), "b".to_string(), "c".to_string(), "d".to_string()];
        let types = vec!["Integer".to_string(), "Float".to_string(), "String".to_string(), "Integer".to_string()];
    ...
    fn test_project_operator() {
        ...
        let schema_in_types = vec!["Integer".to_string(), "String".to_string(), "Float".to_string()];
        let schema_in_distincts = vec![0, 0, 0];
        let schema_in = Schema::new(&schema_in_attrs, &schema_in_types, &schema_in_distincts, 0, "");
        ...
        let schema_out = Schema::new(&schema_out_attrs, &schema_out_types, &schema_out_distincts, 0, "");
    ...
    fn test_scan_with_real_data() {
        ...
        let attributes = vec!["id".to_string(), "name".to_string(), "title".to_string(), "salary".to_string()];
        let types = vec!["Integer".to_string(), "String".to_string(), "String".to_string(), "Integer".to_string()];
        let distincts = vec![0, 0, 0, 0];
        ...
        assert!(db_file.load(&schema, temp_text_file.path().to_str().unwrap()).is_ok());
        db_file.move_first();
    ...
    fn test_complex_query_tree() {
        let attributes = vec!["id".to_string(), "value".to_string(), "category".to_string()];
        let types = vec!["Integer".to_string(), "Integer".to_string(), "String".to_string()];
        let distincts = vec![0, 0, 0];
